  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-3">
    ...
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Infomation page</span>
      </div>
    </li>
  </ol>
</nav>
<div class="m-5 mt-0 p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
    <div class="m-5 mt-0">
        <div class="pb-4">
            <div>
                <p class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Tracking Id: <span class="text-sm"><?php echo $rc['tracking_id']; ?></span></p>
            </div>
            <div>
                <p class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Title: <span class="text-sm"><?php echo $rc['title']; ?></span></p>
            </div>
            <div>
                <p class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Date Created: <span class="text-sm"><?php echo $rc['date']; ?></span></p>
            </div>
            <div class="mt-4">
                <h3 class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Complain:</h3>
                <p><?php echo $rc['complains']; ?></p>
            </div>
            <div class="mt-2">
                <h3 class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Suggestion:</h3>
                <p><?php echo $rc['sugestion']; ?></p>
            </div>
            <div class="mt-2">
                <h3 class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Reply:</h3>
                <p><?php echo $rc['reply']; ?></p>
            </div>
        </div>
    </div>
</div>
