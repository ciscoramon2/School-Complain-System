...
$r = mysqli_fetch_array($q);
    ...
    if(isset($_POST['update'])){
        ...
        $sqlss = "UPDATE tbl_complain SET title = '$title', complains = '$complains', sugestion = '$sugestion' WHERE id = '$id'";

        if ($obj->conn->query($sqlss)){
              $alertt = "<div id='alert-3' class='flex p-4 mb-4 bg-green-100 rounded-lg dark:bg-green-200' role='alert'>
              <svg aria-hidden='true' class='flex-shrink-0 w-5 h-5 text-green-700 dark:text-green-800' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><path fill-rule='evenodd' d='M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z' clip-rule='evenodd'></path></svg>
              <span class='sr-only'>Info</span>
              <div class='ml-3 text-sm font-medium text-green-700 dark:text-green-800'>
                Your complain has been update successfully.
              </div>
  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-3">
    ...
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Update page</span>
      </div>
    </li>
  </ol>
</nav>
