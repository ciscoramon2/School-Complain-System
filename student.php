...
<div class="bg-gray-200 grid md:grid-flow-col m-5 mb-0 rounded-lg mt-8">
    <div class="grid grid-rows place-content-center text-center m-5 md:mr-0 p-6 max-w-md bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <img src="../asset/img/avatar7.png" alt="Admin" style="border-radius: 50%;"  width="150">
            <div class="mt-3">
...
<h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">Sudent Complains Table</h5>
<?php
